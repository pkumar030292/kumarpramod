...
def generate_site_config(site_id, node_type, wan_csv_file, interfaces_csv_file, loopback_csv_file):
...
def main():
    while True:
        ...
        # Get router ID for the global configuration
        router_id = loopback_lookup.get(site_id)
        if router_id:
            ...
            configs = generate_site_config(site_id, node_type, wan_csv_file, interfaces_csv_file, loopback_csv_file)
